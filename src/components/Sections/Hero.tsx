    ...
    <Section noPadding sectionId={SectionId.Hero}>
      <div className="relative h-screen w-full flex items-center justify-center">
        ...
        <div className="z-10 max-w-screen-lg px-3 lg:px-2">
          <div className="mt-3 md:mt-14 p-2 sm:p-3 lg:p-8 lg:gap-7 flex flex-col items-center gap-1 md:gap-4 rounded-xl bg-forest-night-200/80 text-center shadow-lg backdrop-blur-sm">
