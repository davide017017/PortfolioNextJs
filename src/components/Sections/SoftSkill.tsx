...
const SoftSkills: FC = memo(() => {
    const softSkills = [
        ...
        },
        {
            ...
            description: 'Analizzare metodicamente i problemi, sviluppare soluzioni creative e implementarle in modo efficiente.',
        },
        {
            id: 3,
            ...
            description: 'Collaborare efficacemente con gli altri per raggiungere un obiettivo comune, favorendo un ambiente di lavoro positivo e produttivo.',
        },
        {
            id: 4,
            name: 'Adattabilità',
            ...
            description: 'Accogliere il cambiamento, imparare prontamente nuove tecnologie e adattarsi ai requisiti evolutivi del progetto.',
        },
        {
            id: 5,
            ...
            description: 'Organizzare e pianificare efficacemente il tempo per rispettare le scadenze e ottimizzare la produttività.',
        },
        {
            id: 6,
            ...
            description: 'Analizzare le informazioni in modo obiettivo, valutando diverse prospettive per prendere decisioni informate.',
        },
    ];
      ...
      <Section className="bg-dark-olive-50" sectionId={SectionId.SoftSkills}>
          <div className="py-3 ">
              <div className="container mx-auto px-8 ">
                  <h2 className="text-3xl font-bold font-serif text-off-white-100 mb-8 text-center">
                      Soft Skills
                  </h2>
                      ...
                      {softSkills.map((softSkill) => (
                          ...
                          >
                              <div className="flex flex-col items-center text-sage-green-400 "> 
                                  {softSkill.icon}
                                  <span className="mt-2 text-dark-olive-700 text-2xl text-center break-words">
                                      {softSkill.name}
                                  </span>
                              </div>
                              <div className="mt-4 text-center  text-dark-olive-700  max-h-[100px]"> 
